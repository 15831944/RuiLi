...
// 代码生成在 2005年8月17日, 10:15

#include "stdafx.h"
#include "fpt.h"
IMPLEMENT_DYNAMIC(Cfpt, CRecordset)

Cfpt::Cfpt(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_index = 0;
	m_d1 = 0.0;
...
#ifdef _DEBUG
void Cfpt::AssertValid() const
{
	CRecordset::AssertValid();
}

void Cfpt::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
