...
// 代码生成在 2005年8月17日, 10:32

#include "stdafx.h"
#include "fha.h"
IMPLEMENT_DYNAMIC(Cfha, CRecordset)

Cfha::Cfha(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_index = 0;
	m_d1 = 0.0;
...
#ifdef _DEBUG
void Cfha::AssertValid() const
{
	CRecordset::AssertValid();
}

void Cfha::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG
