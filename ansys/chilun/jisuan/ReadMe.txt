================================================================================
    MICROSOFT 基础类库： jisuan 项目概述
===============================================================================

应用程序向导已为您创建了此 jisuan 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 jisuan 应用程序的每个文件的内容摘要。
...
res\Toolbar.bmp
    ...
    更新 jisuan.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导创建一个视图：
jisuanView.h、jisuanView.cpp - 文档视图
    这些文件包含 CjisuanView 类。
/////////////////////////////////////////////////////////////////////////////

数据库支持：

jisuanSet.h、jisuanSet.cpp
    这些文件包含 CjisuanSet 类。  此类用于访问
    在向导中选择的数据源。
    将不添加任何序列化支持。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 jisuan.pch 的预编译头文件 (PCH)
